...
styleNumStylesCount=print_rows['count(*)']
 ...
 #    end
  ...
  assert_equal(search_results_row.size, styleNumStylesCount, "The correct style count must be returned")
  ...
  assert_equal(edit_buttons.size, styleNumStylesCount, "Edit Style buttons are not displayed as expected.")
  ...
  assert_equal(events_buttons.size, styleNumStylesCount, "View Events buttons are not displayed as expected.")
...
assert_equal(skus_buttons.size, styleNumStylesCount, "View Events buttons are not displayed as expected.")
...
assert_equal(persistent_buttons.size, styleNumStylesCount, "View Events buttons are not displayed as expected.")

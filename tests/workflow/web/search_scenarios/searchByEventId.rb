...
# #   # puts "We"
  ...
  eventIdStyleCount=print_rows['count(*)']
end
...
puts "Styles count for the style number from DB: " + eventIdStyleCount.to_s
...
assert_equal(search_results_row.size, eventIdStyleCount, "The correct style count must be returned")
...
assert_equal(edit_buttons.size, eventIdStyleCount, "Edit Style buttons are not displayed as expected.")
...
assert_equal(events_buttons.size, eventIdStyleCount, "View Events buttons are not displayed as expected.")
...
assert_equal(skus_buttons.size, eventIdStyleCount, "View Events buttons are not displayed as expected.")
...
assert_equal(persistent_buttons.size, eventIdStyleCount, "View Events buttons are not displayed as expected.")
